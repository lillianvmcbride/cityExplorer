...
render() {
 return (
   <div className="App">
     ...
     <Input className handleChange = {this.handleChange} handleSearch={this.handleSearch} />
     {this.state.location.place_id && 
        <><h2>Location: {this.state.location.display_name}</h2><h2>Latitude: {this.state.location.lat}</h2><h2>Longitude: {this.state.location.lon}</h2>
